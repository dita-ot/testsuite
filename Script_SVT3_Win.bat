...
REM Create plugin architecture - End user
java -jar lib\dost.jar /i:demo/apiref/sample/apiPackage1.ditamap /outdir:Output/%out%/Plugin_arch/apiref  /transtype:xhtml  /ditaext:dita
java -jar lib\dost.jar /i:demo/javaapiref/sample/javaPackages1.ditamap  /outdir:Output/%out%/Plugin_arch/javaapiref /transtype:xhtml  /ditaext:dita
java -jar lib\dost.jar /i:demo/thesaurus/sample/garageAssociate.ditamap /outdir:Output/%out%/Plugin_arch/thesaurus /transtype:xhtml
REM *******************************************************************
